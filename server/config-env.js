...
const TELEGRAM_TOKEN = process.env.TELEGRAM_TOKEN || ['test', 'dev'].includes(process.env.NODE_ENV) ? '248027235:AAFbrU-WVBSp__tmgEoU-6nJb82LKiTbc3E' : '411396184:AAHkCHvOAmkU7fjs7rFVOshYsKXyMKrulqY';
